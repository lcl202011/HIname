...
$(function() {
	...
	$(window).scroll(function() {
		...
		//导航跟随滚动响应
		if ((s > top1) && (s < top2)) {
			// $(".fr>li").eq(0).removeClass("active").addClass("active");
			// $(".nav-xs-ul li").eq(0).addClass("active").siblings().removeClass("active");
			// $(".fr>li.active").eq(0).removeClass("active");
			...
			// $(".fr>li.active").eq(1).removeClass("active");
			// $(".fr>li").eq(1).addClass("active").removeClass("active");
			// $(".nav-xs-ul li").eq(1).addClass("active").siblings().removeClass("active");
			// $("#section2").addClass("active");
		} else if ((s > top3) && (s < top4)) {
			$(".fr>li.active").eq(1).removeClass("active");
			$("#section4").addClass("active");
			// $(".fr>li").eq(2).addClass("active").siblings().removeClass("active");
			// $(".nav-xs-ul li").eq(2).addClass("active").siblings().removeClass("active");
			// $("#section4").addClass("active");
			// $(".fr>li.active").eq(2).removeClass("active");
		} else if ((s > top4) && (s < top5)) {
			$(".fr>li.active").eq(2).removeClass("active");
			$("#section5").addClass("active");
			// $(".fr>li").eq(3).addClass("active").siblings().removeClass("active");
			// $(".nav-xs-ul li").eq(3).addClass("active").siblings().removeClass("active");
			// $("#section5").addClass("active");
			// $(".fr>li.active").eq(4).removeClass("active");
		} else if ((s > top5) && (s < top6)) {
			$(".fr>li.active").eq(3).removeClass("active");
			$("#section6").addClass("active");
			// $(".fr>li").eq(4).addClass("active").siblings().removeClass("active");
			...
			// $(".fr>li").eq(5).addClass("active").siblings().removeClass("active");
			// $(".nav-xs-ul li").eq(5).addClass("active").siblings().removeClass("active");
			// $("#section7").addClass("active")
			// $(".fr>li.active").eq(5).removeClass("active");
		}
	});
	// 导航slideToggle
